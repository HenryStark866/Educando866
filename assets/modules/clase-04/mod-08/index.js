// taller-modulo-2.js - Estrategias de Rendimiento Óptimo bajo Presión
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Banco de Preguntas (20) - Estrategias de Rendimiento Óptimo bajo Presión
    ...
    async function submitExam() {
        ...
        const result = await saveWorkshopResults('Estrategias de Rendimiento Óptimo bajo Presión', userAnswers, correctAnswersArray);
        ...
        if (result && result.success) {
            ...
            submitPanel.innerHTML = `
                ...
                <p class="text-gray-600 mb-2">Tu puntuación en Estrategias de Rendimiento Óptimo bajo Presión es:</p>
                ${fbWarning}
