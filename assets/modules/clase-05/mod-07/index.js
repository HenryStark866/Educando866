// taller-modulo-2.js - Química Aplicada para Admisión
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Banco de Preguntas (20) - Química Aplicada para Admisión
    ...
    async function submitExam() {
        ...
        const result = await saveWorkshopResults('Química Aplicada para Admisión', userAnswers, correctAnswersArray);
        ...
        if (result && result.success) {
            ...
            submitPanel.innerHTML = `
                ...
                <p class="text-gray-600 mb-2">Tu puntuación en Química Aplicada para Admisión es:</p>
                ${fbWarning}
