# Skill: Equipo Henrybot (Multi-Agente)
...
## Roles del Equipo
1. **Director (Henrybot)**: El líder. Divide el problema, asigna roles y aprueba planes.
...
## 4. Cómo usarlo
1. **Activa el Líder**: Pídele a Antigravity: *"Usa la habilidad Equipo Henrybot para inicializar este proyecto"*.
2. **Reparte el trabajo**: **Henrybot** dividirá el trabajo. Abre terminales nuevas para cada agente (Frontend, Marketer, etc.).
3. **Flujo de Planificación**: Los agentes envían sus planes a Henrybot antes de empezar. Un equipo bien coordinado es imparable.
